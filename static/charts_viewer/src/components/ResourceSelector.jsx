      ...
      <div>
        ...
        <div className="row" style={{
          ...
          <div className="col-xs-12 col-sm-6 col-md-8 col-lg-8">
            <Search username= {this.state.mymaps===true?this.props.username:null} searchResources={(mapTitle) => {
        ...
        {!this.state.loading && this.state.resources.map((resource) => {
          return (
            <div onClick={() => this.props.selectMap(resource)} key={resource.id} className={(this.props.instance
              ...
              <div className="col-xs-12 col-sm-4 col-md-4 col-lg-4 resource-box-img-container">
                <Img className="resource-box-img img-responsive" src={[resource.thumbnail_url, "/static/app_manager/img/no-image.jpg"]} loader={< Spinner name = "line-scale-pulse-out" color = "steelblue" />}/>
              </div>
              ...
              <div className="col-xs-12 col-sm-8 col-md-8 col-lg-8 resource-box-text">
                ...
                <div className="row">
                  ...
                  <div className="col-md-8">
                    <a type="button" href={`/maps/${resource.id}`} target="_blank" className="btn btn-primary" style={{
                      margin: "5px",
                      float: "right"
                    }}>
                      Map Details
